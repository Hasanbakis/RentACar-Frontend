...
export class ColorListComponent implements OnInit {
  ...
  constructor(
    private colorService:ColorService ,private toastrService:ToastrService,private formBuilder:FormBuilder
  ) { }
  ...
  addColor(){
    if(this.colorAddForm.valid){
      ...
      this.colorService.addColor(addColorModel).subscribe(response=>{
